		...
		return (
			<div className="min-h-screen bg-base-100 flex items-center justify-center">
				<div className="text-center">
					...
					<p className="text-base-content/70 mb-4">The pump you're looking for doesn't exist.</p>
					<button 
	...
	return (
		<div className="min-h-screen bg-base-100">
			...
			<div className="p-4 sm:p-6">
				<form id="pump-form" onSubmit={handleSubmit(onSubmit)} className="space-y-6">
					<div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
						...
						<div className="card bg-base-200 shadow-lg">
							<div className="card-body">
								...
								<div className="form-control">
									<label className="label">
										<span className="label-text font-medium">Current Ingredient</span>
									</label>
									<select
										className="select select-bordered w-full"
						...
						<div className="card bg-base-200 shadow-lg">
							<div className="card-body">
								...
								{(pumpType === "dc" || pumpType === "valve") && (
									<div className="form-control">
										<label className="label">
											<span className="label-text font-medium">Control Pin</span>
										</label>
										<select
											className="select select-bordered w-full"
								...
								{pumpType === "stepper" && (
									<>
										<div className="form-control">
											<label className="label">
												<span className="label-text font-medium">Enable Pin</span>
											</label>
											<select
												className="select select-bordered w-full"
								...
								<div className="form-control">
									<label className="label cursor-pointer">
										<span className="label-text font-medium">Power State High</span>
										<input
											type="checkbox"
						...
						<div className="card bg-base-200 shadow-lg">
							<div className="card-body">
								...
								<div className="form-control">
									<label className="label">
										<span className="label-text font-medium">Time per CL (ms)</span>
									</label>
									<input
										type="number"
									...
									{errors.timePerClInMs && (
										<label className="label">
											<span className="label-text-alt text-error">{errors.timePerClInMs.message}</span>
										</label>
									)}
								</div>
								...
								{pumpType === "stepper" && (
									<>
										<div className="form-control">
											<label className="label">
												<span className="label-text font-medium">Acceleration</span>
											</label>
											<input
												type="number"
												className="input input-bordered w-full"
											...
											{errors.acceleration && (
												<label className="label">
													<span className="label-text-alt text-error">{errors.acceleration.message}</span>
												</label>
											)}
										</div>
										...
										<div className="form-control">
											<label className="label">
												<span className="label-text font-medium">Max Steps per Second</span>
											</label>
											<input
												type="number"
												className="input input-bordered w-full"
											...
											{errors.maxStepsPerSecond && (
												<label className="label">
													<span className="label-text-alt text-error">{errors.maxStepsPerSecond.message}</span>
												</label>
											)}
										</div>
										...
										<div className="form-control">
											<label className="label">
												<span className="label-text font-medium">Steps per CL</span>
											</label>
											<input
												type="number"
												className="input input-bordered w-full"
											...
											{errors.stepsPerCl && (
												<label className="label">
													<span className="label-text-alt text-error">{errors.stepsPerCl.message}</span>
												</label>
											)}
										</div>
									</>
						...
						<div className="card bg-base-200 shadow-lg">
							<div className="card-body">
								...
								<div className="form-control">
									<label className="label">
										<span className="label-text font-medium">Tube Capacity (ml)</span>
									</label>
									<input
										type="number"
										className="input input-bordered w-full"
									...
									{errors.tubeCapacityInMl && (
										<label className="label">
											<span className="label-text-alt text-error">{errors.tubeCapacityInMl.message}</span>
										</label>
									)}
								</div>
								...
								<div className="form-control">
									<label className="label">
										<span className="label-text font-medium">Filling Level (ml)</span>
									</label>
									<input
										type="number"
										className="input input-bordered w-full"
									...
									{errors.fillingLevelInMl && (
										<label className="label">
											<span className="label-text-alt text-error">{errors.fillingLevelInMl.message}</span>
										</label>
									)}
								</div>
