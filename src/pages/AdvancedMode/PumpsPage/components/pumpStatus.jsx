	...
	return (
		<div className="card bg-base-100 shadow-lg">
			<div className="collapse collapse-arrow">
				...
				<div className="collapse-title bg-base-200 rounded-t-2xl font-semibold text-base sm:text-lg flex items-center break-words px-4 sm:px-6 py-3 sm:py-4">
					...
					<div className="flex flex-col divide-y divide-base-200">
						...
						<div className="p-3 sm:p-4 lg:p-6">
							...
							<div className="grid grid-cols-1 sm:grid-cols-2 gap-y-2 gap-x-2 sm:gap-x-4">
								<div className="text-sm break-words flex justify-between sm:block">
									<span className="sm:hidden">{t("pump_status.pumps_installed")}</span>
									<span className="hidden sm:block">{t("pump_status.pumps_installed")}</span>
								...
								<div className="text-sm break-words flex justify-between sm:block">
									<span className="sm:hidden">{t("pump_status.pumps_ingredients_installed")}</span>
									<span className="hidden sm:block">{t("pump_status.pumps_ingredients_installed")}</span>
									<span className="sm:hidden">
						...
						<div className="p-3 sm:p-4 lg:p-6">
							...
							<div className="grid grid-cols-1 sm:grid-cols-2 gap-y-2 gap-x-2 sm:gap-x-4">
								<div className="text-sm break-words flex justify-between sm:block">
									<span className="sm:hidden">{t("pump_status.reverse_pumping")}</span>
									<span className="hidden sm:block">{t("pump_status.reverse_pumping")}</span>
									<span className="sm:hidden">
										<span
								...
								{reversePumpSettings?.enable && (
									<>
										<div className="text-sm break-words flex justify-between sm:block">
											<span className="sm:hidden">{t("pump_status.reverse_pumping_overshoot")}</span>
											<span className="hidden sm:block">{t("pump_status.reverse_pumping_overshoot")}</span>
											<span className="sm:hidden">
										...
										<div className="text-sm break-words flex justify-between sm:block">
											<span className="sm:hidden">{t("pump_status.reverse_pumping_timer")}</span>
											<span className="hidden sm:block">{t("pump_status.reverse_pumping_timer")}</span>
											<span className="sm:hidden">
												<span className="badge badge-ghost break-words text-xs">
						...
						<div className="p-3 sm:p-4 lg:p-6">
							...
							<div className="grid grid-cols-1 sm:grid-cols-2 gap-y-2 gap-x-2 sm:gap-x-4">
								<div className="text-sm break-words flex justify-between sm:block">
									<span className="sm:hidden">{t("pump_status.load_cell_status")}</span>
									<span className="hidden sm:block">{t("pump_status.load_cell_status")}</span>
									<span className="sm:hidden">
										<span
								...
								{loadCellSettings?.enable && (
									<>
										<div className="text-sm break-words flex justify-between sm:block">
											<span className="sm:hidden">{t("pump_status.load_cell_calibrated")}</span>
											<span className="hidden sm:block">{t("pump_status.load_cell_calibrated")}</span>
											<span className="sm:hidden">
												<span
