		...
		return (
			<div className="form-control w-full">
				...
				<div className="flex items-center gap-3 p-4 bg-base-100 rounded-lg border border-base-300">
					...
					<span className="text-base-content/60 text-sm sm:text-base">Loading glass...</span>
				</div>
			</div>
		);
	}
	...
	if (!selectedGlass) {
		return (
			<div className="form-control w-full">
				...
				<div className="flex items-center gap-3 p-4 bg-base-100 rounded-lg border border-base-300">
					<GlassWater size={20} className="text-base-content/40" />
					<span className="text-base-content/60 text-sm sm:text-base">No glass selected</span>
				</div>
			</div>
		);
	}
